...
cap=cv2.VideoCapture("Videosvideo1.mp4")
...
while(cap.isOpened()):
    ...
    #------------------------------------------------------BINARIZATION----------------------------------------------------------------------------
    if ret==True:
        ret,imBin=cv2.threshold(fgmask,200,255,cv2.THRESH_BINARY)  #isko dekh lena
        ...
        for i in cars:
            ...
            if line_down+20<= i.getY() <= line_up-20:
                ...
                if a >= 0:
                    cv2.putText(frame, "Truck", (i.getX(), i.getY()), font, 1, (0,255,255), 1, cv2.LINE_AA)
                else:
                    cv2.putText(frame, "car", (i.getX(), i.getY()), font, 1, (0,0,255), 1, cv2.LINE_AA)
        ...
        frame=cv2.line(frame,(0,line_up),(900,line_up),(255,0,255),1,8) #Magenta

        frame = cv2.line(frame, (0, line_down), (900, line_down), (255, 0,0), 1, 8) #Blue

        #To display the Texts
        cv2.putText(frame, str_up, (10, 40), font, 0.5, (0, 0, 255), 1, cv2.LINE_AA)
        cv2.putText(frame, str_down, (10, 90), font, 0.5, (255, 0, 0), 1, cv2.LINE_AA)
        # line_aa bhi padh lena
